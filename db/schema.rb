...
ActiveRecord::Schema[7.1].define(version: 20_250_911_174_051) do
  ...
  create_table 'habit_records', force: :cascade do |t|
    ...
    t.index %w[user_id habit_id recorded_at], name: 'index_habit_records_on_user_habit_date', unique: true
  ...
  create_table 'user_badges', force: :cascade do |t|
    ...
    t.index %w[user_id badge_id], name: 'index_user_badges_on_user_id_and_badge_id', unique: true
